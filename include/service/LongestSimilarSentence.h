...
class LongestSimilarSentence
{
    public:
        ...
        void GetSimBoundary(const std::vector<SplitedHits> vec_SearchWords,const std::vector<SplitedHits> vec_OriginWords,std::vector<SenRangeSimilarity>& vec_SenRangeSimilarity);
    protected:
