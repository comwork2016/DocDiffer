...
const static int TextSame = 0;
const static int TextSimilar = 1;
const static int TextDifferent = 2;
const static int TextIgnore = 3;
...
struct TextRange
{
    ...
    int length;//结束偏移值
    int number;//对应的编号
    int n_Similar;//0-相似度为1, 1:句子相似, 2:句子不一样
};
